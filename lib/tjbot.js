...
TJBot.prototype._setupPreview = function() {
    ...
    if (!this.configuration.see.preview.hf) {
        delete this.configuration.see.preview.hf;
    }
    if (!this.configuration.see.preview.vf) {
        delete this.configuration.see.preview.vf;
    }
    this._preview = new RaspiCam(this.configuration.see.preview);
}
